...
while True:
    ...
    while not declaracion_victoria:
        os.system('cls' if os.name == 'nt' else 'clear')  # Limpiar terminal al inicio del bucle6
        ...
        #     continue  # Vuelve a preguntar si la entrada es inválidan
